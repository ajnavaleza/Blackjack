 ...
 * 
 * @author cmsc132 2006 Copyright (C) 2006 University of Maryland
 * 
 * @see Card
 */
public interface BlackjackEngine {
	 ...
	 */
	public int getNumberOfDecks(); // DONE

	/**
	 * Creates and shuffles the card deck(s) using a random number generator.
	 */
	public void createAndShuffleGameDeck(); // DONE
	 ...
	 */
	public Card[] getDealerCards(); // DONE
	 ...
	 * dealer's cards have a value less than 21, BUST if the dealer's cards have a
	 * value greater than 21, and BLACKJACK if the dealer has an Ace along with a
	 * "10", Jack, Queen, or King. If the dealer's cards have a value equivalent to
	 ...
	 */
	public int getDealerCardsEvaluation(); // DONE
	 ...
	 */
	public Card[] getPlayerCards(); // DONE
	 ...
	 *         smaller value must appear in the first array entry.
	 */
	public int[] getPlayerCardsTotal(); // DONE
	 ...
	 */
	public void setBetAmount(int amount); // DONE
	 ...
	 * @param amount
	 */
	public void setAccountAmount(int amount); // DONE
	 ...
	 */
	public int getAccountAmount(); // DONE
